// src/app/(auth)/login/LoginContent.jsx
"use client";
...
export default function LoginContent() {
  // *** This is the key component that uses the client-side hook ***
  const { signIn, signInWithGoogle, loading, user, setLoading } =
    useContext(AuthContext);
  const router = useRouter();
  const searchParams = useSearchParams(); // <-- useSearchParams() is now safely here
  ...
  const handleGoogleSignIn = async () => {
    // ... (your existing handleGoogleSignIn logic)
    try {
  ...
  return (
    // *** Paste all the JSX content of your original Login component here ***
    <div className="flex justify-center items-center min-h-screen bg-white">
      {/* ... (rest of the login form JSX) ... */}
