// src/app/(auth)/register/RegisterContent.jsx
"use client";
...
// Rename the default function to RegisterContent
export default function RegisterContent() {
  // All client-side hooks, including useSearchParams(), are now here
  const { createUser, updateUserProfile, signInWithGoogle, loading } =
    use(AuthContext);
  const router = useRouter();
  const searchParams = useSearchParams(); // <-- Safely inside a client component
  ...
  return (
    // Paste all the JSX content of your original Register component here
